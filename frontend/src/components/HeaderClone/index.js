...
function HeaderClone({ referenceNo }) {
    ...
    try {
      ...
      previewWindow.document.write(`
        ...
        <html>
          ...
          <body>
            <div class="toolbar">
              <div class="title">Damage Assessment Report - ${referenceNo}</div>
              <div class="buttons">
                <button id="downloadBtn" class="btn btn-primary">Download PDF</button>
                <button id="closeBtn" class="btn btn-secondary">Close Preview</button>
              </div>
            </div>
            <div class="viewer">
